...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container my-3">
            ...
            <p><u>Your phrase has { text.length } letters and {text===""? 0 : text.split(" ").length} words</u></p>
            {/* <p><u>Letters: {text.length}</u></p> */}
            {/* <p><u>Words: {text===""? 0 : text.split(" ").length}</u></p> */}
            <p><u>{"A normal reader may read this phrase in " +0.008 * text.split(" ").length+" minutes"}</u></p>
